...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    ...
    'zh_CN': {
      "pleaseBringPayment": "请携带此单到收银处付款.",
    ...
    'en_US': {
      "pleaseBringPayment": "Please bring this form to the cashier to make a payment.",
      ...
      "station": "Station",
      "date": "Date",
      "peopleNumber": "Persion",
      "scanQrCode": "Please scan the QR code above to order food by yourself.",
      "tableNo": "Table",
      "table": "Table",
      "orderNo": "Inv.",
      "customer": "Customer",
...
abstract class LocaleKeys {
  ...
  static const String pleaseBringPayment = "pleaseBringPayment";
}
